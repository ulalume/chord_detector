...
namespace ChordDetector {
    ...
    constexpr ChordPattern CHORD_PATTERNS[] = {
        ...
        {(1<<0)|(1<<2)|(1<<4)|(1<<11), "M9(omit5)",   85},   // Maj9 omit5: R,M2,M3,M7
        {(1<<0)|(1<<2)|(1<<3)|(1<<10), "m9(omit5)",     85},   // Min9 omit5: R,M2,m3,m7

        // 7th chords
        {(1<<0)|(1<<4)|(1<<7)|(1<<10), "7",      80},   // Dom7: R,M3,P5,m7
        {(1<<0)|(1<<4)|(1<<7)|(1<<11), "M7",   80},   // Maj7: R,M3,P5,M7
        ...
        {(1<<0)|(1<<3)|(1<<6)|(1<<9), "dim7",   75},   // Dim7: R,m3,b5,d7
        {(1<<0)|(1<<5)|(1<<7)|(1<<10), "7sus4",  70},   // 7sus4: R,P4,P5,m7
        {(1<<0)|(1<<2)|(1<<7)|(1<<10), "7sus2",  70},   // 7sus2: R,M2,P5,m7
        {(1<<0)|(1<<5)|(1<<7)|(1<<11), "M7sus4", 70}, // Maj7sus4: R,P4,P5,M7
        {(1<<0)|(1<<2)|(1<<7)|(1<<11), "M7sus2", 70}, // Maj7sus2: R,M2,P5,M7

        // 7th chords omit5
        {(1<<0)|(1<<4)|(1<<10), "7(omit5)",      72},   // Dom7 omit5: R,M3,m7
        {(1<<0)|(1<<4)|(1<<11), "M7(omit5)",   72},   // Maj7 omit5: R,M3,M7
        ...
        // Sus chords with 7th (duplicates removed)

        // Basic triads
        {(1<<0)|(1<<4)|(1<<7), "",       60},   // Major: R,M3,P5
        {(1<<0)|(1<<3)|(1<<7), "m",      60},   // Minor: R,m3,P5
        {(1<<0)|(1<<4)|(1<<8), "aug",    45},   // Aug: R,M3,m6
        {(1<<0)|(1<<3)|(1<<6), "dim",    45},   // Dim: R,m3,b5
        {(1<<0)|(1<<4)|(1<<6), "b5",     50},   // Flat 5: R,M3,b5

        // Augmented 7th chords
        {(1<<0)|(1<<4)|(1<<8)|(1<<11), "augM7", 75},   // AugMaj7: R,M3,m6,M7
        {(1<<0)|(1<<4)|(1<<8)|(1<<10), "aug7",  75},   // Aug7: R,M3,m6,m7
        ...
        {(1<<0)|(1<<3)|(1<<6)|(1<<7), "m(add#11)", 48}, // Minor add sharp 11: R,m3,#11,P5 (C-D#-F#-G)
        {(1<<0)|(1<<3)|(1<<6)|(1<<11), "M7#11", 46}, // Major 7 sharp 11: R,m3,#11,M7 (C-D#-F#-B)
